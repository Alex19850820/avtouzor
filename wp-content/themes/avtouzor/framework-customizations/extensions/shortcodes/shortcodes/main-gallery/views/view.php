...
<section class="work-section" id="work">
	<div class="container">
		...
		<div class="work-two">
			<div class="work-left">
				<img class="work-left__first" src="<?php bloginfo('template_url')?>/assets/images/works_photo_1.png" alt="" width="364px" height="207px" role="presentation"/>
				<img class="work-left__two" src="<?php bloginfo('template_url')?>/assets/images/works_photo_2.png" alt="" width="364px" height="208px" role="presentation"/>
			</div>
			<div class="work-center">
				<div class="work-center-up">
					<img class="work-center-up__five five-two" src="<?php bloginfo('template_url')?>/assets/images/works_photo_5.png" alt="" width="268px" height="135px" role="presentation"/>
					<img class="work-center-up__five" src="<?php bloginfo('template_url')?>/assets/images/works_photo_5.png" alt="" width="267px" height="135px" role="presentation"/>
				</div>
				<div class="work-center-down">
					<div class="work-center-down-left">
						<img class="work-center-down-left__three" src="<?php bloginfo('template_url')?>/assets/images/works_photo_3.png" alt="" width="180px" height="135px" role="presentation"/>
						<img class="work-center-down-left__four" src="<?php bloginfo('template_url')?>/assets/images/works_photo_4.png" alt="" width="180px" height="135px" role="presentation"/>
					</div>
					<div class="work-center-down-right">
						<img class="work-center-down-right__six" src="<?php bloginfo('template_url')?>/assets/images/works_photo_6.png" alt="" width="355px" height="280px" role="presentation"/>
					</div>
				</div>
			</div>
